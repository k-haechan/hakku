...
실제 배포된 학꾸 서비스(<https://hakku.rearleg.com>)의 화면입니다.

| 홈 | 상품 상세 |
|---|---|
| ![학꾸 홈](screenshots/01-home.png) | ![상품 상세](screenshots/02-product-detail.png) |
| 히어로 캐러셀 · 퍼스널컬러 진단 진입 · 상품/커뮤니티 밴드 | 옵션 선택 후 **결제하기** → 결제 서버(토스페이먼츠) 흐름 진입 |

![상품 목록](screenshots/03-products.png)

> 퍼스널컬러 진단 결과·AI 챗봇 대화·토스 결제위젯은 로그인 회원 전용이라 여기서는 생략했습니다.
